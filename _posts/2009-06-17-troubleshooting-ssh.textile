...
p(. I had this problem with msysgit on Windows Server 2008 64bit.  Eventually fixed it by ensuring that the plink & pageant executables were the 64 bit builds from "LLoyd Sparkes":http://blog.lloydsparkes.co.uk/putty-x64/  -- "ciaranj":http://github.com/ciaranj
